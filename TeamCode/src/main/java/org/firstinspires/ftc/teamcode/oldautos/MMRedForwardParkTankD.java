...
@Autonomous(name = "MMRedForwardParkTankD", group = "Drivetrain")
public class MMRedForwardParkTankD extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        bot.driveUntil(-0.15, 0,0,0, "red");
        bot.driveAuto(0.5, 0,0,0,0.1);
