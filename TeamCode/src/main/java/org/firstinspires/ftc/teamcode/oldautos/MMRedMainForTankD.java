...
@Autonomous(name = "MMAutoRedMainTankD", group = "Drivetrain")
public class MMRedMainForTankD extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Telemetry tele = null;
        //position 0 for wrist is ground pick up
        wrist.setPosition(0);

        //position 1 for claw is closed
        ...
        bot.driveAuto(0.45, 0,0,0,1);
        //last last time = "0.34250004000000200001000003000320120104" last time = "9e-100"
        bot.driveAuto(0, 0,-0.5,0,0.7);
        bot.driveAuto(0.09, 0,-0,0,0.01);
        claw.moveAuto(-1, 1);
        grabber.setPosition(0);
        bot.driveAuto(0, 0, 0, 0, 0);
        /*while (!color.equals("red")) {
            color = csensor.getColor();
            bot.driveAuto(-1,0,0,0,0.1);
        }*/
