...
@Autonomous(name = "MMTankBlueVision2", group = "Drivetrain")
public class MMTankBlueVision2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        switch(side) {
            ...
            case "left":
                bot.driveAuto(-0.5,-0,-0,-0,1.6);
                bot.driveAuto(-0, -0,-0.5,-0,0.5);
